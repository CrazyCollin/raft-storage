...
type RaftServiceClient interface {
	...
	Snapshot(ctx context.Context, in *InstallSnapshotReq, opts ...grpc.CallOption) (*InstallSnapshotResp, error)
}
...
func (c *raftServiceClient) Snapshot(ctx context.Context, in *InstallSnapshotReq, opts ...grpc.CallOption) (*InstallSnapshotResp, error) {
...
type RaftServiceServer interface {
	...
	Snapshot(context.Context, *InstallSnapshotReq) (*InstallSnapshotResp, error)
...
func (UnimplementedRaftServiceServer) Snapshot(context.Context, *InstallSnapshotReq) (*InstallSnapshotResp, error) {
...
func _RaftService_Snapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServiceServer).Snapshot(ctx, req.(*InstallSnapshotReq))
	}
	return interceptor(ctx, in, info, handler)
}
